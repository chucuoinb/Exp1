        ...
        <div class="info">
            <div id="inf1" class="inf">
                ...
                <ul style="padding: 0px">
                    <li><img style="margin-right: 8px" src="../images/addr.png"/>9 Archdale, 28 Charleston</li>
                    <li><img style="margin-right: 8px" src="../images/fone.png"/> +777 (100) 1234</li>
                    <li><img style="margin-right: 8px" src="../images/ml.png"/> mail@example.com</li>
                </ul>
            </div>
    ...
    <div class="license">
        <div class="infolicense">
            <br/>
            <p style="margin: 0; color: #999999">&#169; Breeze Store Theme, 2012</p>
            <div class="share" style="margin-right: 0">
                <a href="#fb"><img src="../images/fb.png"/></a>
                <a href="#tw"><img src="../images/tw.png"/></a>
                <a href="#gg"><img src="../images/gg.png"/></a>
            </div>
        </div>
    </div>